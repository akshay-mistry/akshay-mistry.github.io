  ...
  return (
    ...
    <section className='min-h-[85vh] lg:min-h[78vh] flex items-center' id='home'>
      <div className="container mx-auto">
        ...
        <div className='flex flex-col gap-y-8 lg:flex-row lg:iterms-center lg:gap-x-12'>
          {/** text */}
          ...
          <div className='flex-1 text-center font-secondary lg:text-left'>
            ...
            <div className='flex max-w-lg gap-x-6 mb-12 mx-auto lg:mx-0'>
              <motion.button
                variants={fadeIn('up', 0.4)} 
                initial="hidden" 
                whileInView={'show'} 
                ...
                <a href="https://linkedin.com/in/akshaymistry-" target="_blank" rel="noopener noreferrer">Resume</a>
              </motion.button>
